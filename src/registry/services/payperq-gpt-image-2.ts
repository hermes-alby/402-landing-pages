...
const service = {
  ...
  summary: 'PPQ models API lists GPT Image 2 with low, medium, and high quality tiers plus optional image-input controls, making it a strong next image-generation landing page candidate.',
  notes: [
