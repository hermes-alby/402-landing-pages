...
- `docs/provider-intake-and-activation.md` — provider-intake workflow, provider and service registry direction, phased activation notes, current Phase C batch notes, Sats4AI evaluation notes, wallet setup notes, live paid-test summary, and registry implementation notes
